...
export const ProductTable: React.FC<ProductTableProps> = ({ onOpenForm }) => {
  ...
  return (
    <>
                    ...
                    >
                      ...
                      <td className="p-4 pr-6">
                        <div className={`flex justify-end gap-1 transition-opacity ${isArchived ? 'opacity-30' : 'opacity-100'}`}>
                          ...
                          {/* NEW RECIPE BUILDER BUTTON */}
                          <button 
                            onClick={() => setRecipeProduct(product)} 
                            className="p-2 text-gray-400 hover:text-orange-600 rounded-lg hover:bg-white hover:shadow-sm transition-all"
      ...
      {/* RECIPE BUILDER MODAL COMPONENT */}
      <RecipeBuilderModal 
